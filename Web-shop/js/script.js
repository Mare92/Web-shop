...
xhttp.open ("GET", "https://63356052ea0de5318a1200e9.mockapi.io/products", true);
xhttp.send();
...
function add_to_cart(el) {
    ...
    document.getElementById("myCart").innerHTML = "<div class='row'>" +
                                                   " <div class='col-md-9'><h2>Your cart items</h2></div>" +
    ...
    xhttp.open ("GET", "https://63356052ea0de5318a1200e9.mockapi.io/products/" + id, true);
    xhttp.send();
}
